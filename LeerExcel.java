...
import static co.com.devco.utils.RutasExcel.NUMERO_CASOS;
...
public class LeerExcel {
    ...
    public static void cambiarValor(int numeroFila, int numeroColumna, String valor) throws FileNotFoundException {

        try {
            FileInputStream file = new FileInputStream(NUMERO_CASOS);
            ...
            FileOutputStream output = new FileOutputStream(NUMERO_CASOS);
            wb.write(output);
            output.close();
